...
namespace MVCEmployeeCrud.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Empno,Name,Gender,Dept,Desgn,Basic")] Employee employ)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Empno,Name,Gender,Dept,Desgn,Basic")] Employee employ)
        {
            if (id != employ.Empno)
            {
                return NotFound();
