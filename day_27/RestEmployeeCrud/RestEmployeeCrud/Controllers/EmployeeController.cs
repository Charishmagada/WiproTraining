...
namespace RestEmployeeCrud.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        // GET: api/Employs/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Employee>> GetEmploy(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutEmploy(int id, Employee employ)
        {
            if (id != employ.Empno)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Employee>> PostEmploy(Employee employ)
        {
